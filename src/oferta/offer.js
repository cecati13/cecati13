const BD_SPECIALITIES = {
    administracion : {
        ...
        courses: [
            ...
            "Estima el Cálculo de los Costos de la Cadena Logística",
            ...
            "Maneja y Procesa Información Financiera",
            "Auxilia en la Regulación Legal de la Empresa",
            "Auxilia en el Control Administrativo de la Empresa",
            "Auxilia en el Diseño de Planes de Vida Empresarial",
            "Asiste al Empresario en Operaciones Financieras",
            ...
            "Realiza la Gestión Administrativa en las MiPyMEs",
            "Aplica los Procesos de Atención al Cliente y Ventas en las MiPyMEs",
            "Analiza Fuentes de Financiamiento en el Marco de una Cultura Financiera en las MiPyMEs",
            "Realiza los Procesos Legales y Fiscales en las MiPyMEs",
    ...
    artesGraficas : {
        ...
        courses: [
            ...
            "Utiliza las Herramientas del Software Gráfico",
            "Desarrolla la Matriz Impresora",
            "Efectúa la impresión a una tinta",
            "Elabora la impresión a dos tintas o más",
            "Transforma el producto impreso",            
        ]
    },
    ...
    asistenciaEducativa : {
        ...
        courses: [
            "Elaboración de Manualidades Escolares con Materiales Convencionales y de Reúso",
            "Bailes y Danzas Tradicionales Infantiles",
            "Cuentacuentos",
            "Atención Integral a Niños Lactantes",
            "Atención Integral a Niños Maternales",
            "Atención Integral a Niños Preescolares",
            "Estimulación Temprana para Niños Lactantes",
            "Estimulación Temprana para Niños Maternales",
            "Asistencia a Niños con Discapacidad y Aptitudes Sobresalientes (Curso Especializado)",
            "Aplicación de Funciones Básicas en Inglés para Asistencia Educativa Inicial y Preescolar",
            ...
            "Auxilia en la Identificación y Diagnóstico de Personas con Aptitudes Sobresalientes y/o Talentos Específicos",
            "Planea Actividades de Enriquecimiento y Aceleración para Personas con Aptitudes Sobresalientes y/o Talentos Específicos",
            "Diseña y Elabora Material Didáctico para Actividades Dirigidas a Personas con Aptitudes Sobresalientes y/o Talentos Específicos",
            "Realiza Actividades Psicopedagógicas de Enriquecimiento y Aceleración para Personas con Aptitudes Sobresalientes y/o Talentos Específicos",
            "Orienta y Canaliza a los Usuarios a Instituciones Especializadas que Atienden a Personas con Aptitudes Sobresalientes y/o Talentos Específicos",
    ...
    atencionAdultosMayores : {
        ...
        courses: [
            "Atención Primaria de la Salud a Personas Adultas Mayores",
            "Asistencia a Personas Adultas Mayores Autónomas y con Dependencia Leve",
            "Asistencia a Personas Adultas Mayores con Dependencia Moderada",
            "Asistencia a Personas Adultas Mayores en el Hogar",
            "Asistencia a Personas Adultas Mayores en Centros de Día y Estancias Permanentes",
            "Asistencia a Personas Adultas Mayores con Dependencia Severa",
            "Cuidados Paliativos a Personas Adultas Mayores",
            "Asistencia en Centros de Día y Estancias Permanentes al Adulto Mayor",            
        ]
    },
    ...
    atencionPersonasConDiscapacidad : {
        ...
        courses: [
            "Orientación Familiar y Escolar para Personas con Discapacidad",
            ...
            "Manejo de la Sexualidad en la Discapacidad",
            "Atención Básica para Personas con Discapacidad",
            "Comunicación Asertiva con Lenguaje de Señas Mexicana (LSM)",
            "Asiste a Personas con Discapacidad Motora",
            "Asiste a Personas con Discapacidad Visual y de Baja Visión",
            "Asiste a Personas con Discapacidad Auditiva con o sin Lengua de Señas Mexicana",
            "Orienta a Familias que Conviven con Personas con Discapacidad",
            "Asiste Personas Adultas Mayores",
            "Aplicación de Funciones Básicas en ingles para Atención Integral a Personas con Discapacidad"
        ]
    },
    ...
    confeccionIndustrialRopa : {
        ...
        courses: [
            ...
            "Confecciona Prendas de Vestir",
            "Corta en Serie Prendas de Vestir",
            "Supervisa la Confección de Prendas de Vestir",
            "Asiste en la Planeación de Producción de Prendas de Vestir",            
        ]
    },
    ...
    carpinteria : {
        ...
        courses: [
            "Elaboración de Centro de Entretenimiento",
            "Elaboración de Buró",
            ...
            "Aplicación de Funciones Básicas en Inglés para Diseño y Fabricación de Muebles de Madera",
            "Diseña Muebles de Madera utilizando Técnicas Manuales",
            "Diseña Muebles de Madera utilizando Software",
            "Produce Piezas y da Mantenimiento Preventivo a Máquinas para la Fabricación de Muebles de Madera",
            "Fabrica, Ensambla y Aplica Acabados en Muebles de Madera",
            "Desarrolla un Proyecto Emprendedor para Fabricación de Muebles de Madera",
    ...
    diseñoDeModa : {
        ...
        courses: [
            "Investigación de la Indumentaria y la Moda",
            "Integración de Elementos de un Book de Moda",
            "Ilustración de Moda",
            "Modelado en Maniquí",
            "Patronaje de Moda",
            "Graduación de Moldes",
            "Creación de Alta Moda",
            "Creación de Colección de Moda",
            "Diseño de Portafolio Digital de Moda",
            "Patronaje y Graduación en Computadora",
            "Aplicación de Funciones Básicas en inglés para Diseño de Moda",
            "Dibuja Prendas de Moda",
            "Elabora Patrones de Prendas de Vestir",
            "Confecciona Prendas de Vestir",
            "Gradúa Prendas de Vestir",
    ...
    artesaniasDeMadera : {
        ...
        courses: [
            "Aplicación de la Técnica Bajo Relieve en Madera",
            "Elaboración de Pinturas al Óleo con Técnicas de Fundido y Empaste",
            "Elaboración de Soportes para Pintura al Óleo",
            "Elaboración de Artesanías de Talla en Madera",
            "Pintura al Óleo Aplicada a la Madera",
            "Elaboración de Artesanías de Mimbre, Vara y Bejuco",
            "Elaboración de Pirograbado en Madera",
            "Acabados para las Artesanías de Madera",
            "Restauración Artística de Artesanías de Madera (Curso Especializado)",
            "Aplicación de Funciones Básicas en inglés para Elaboración de Joyería y Orfebrería y Elaboración y Restauración de Artesanías de Madera",
        ]
    },
    ...
    expresionGraficaDigital : {
        ...
        courses: [
            ...
            "Representa Gráficamente Ideas y Conceptos de un Proyecto Audiovisual",
            "Modela Objetos Bidimensionales y Tridimensionales",
            "Produce Videos Digitales",
            "Anima Motion Graphics",
            "Diseña Páginas Web Responsive",
    ...
    floristeria : {
        ...
        courses: [
            "Diseños Florales de Ocasión",
            "Ornamento Floral",
            "Aplicación de Funciones Básicas en inglés para Floristería",
            "Aplicación de Principios del Diseño Floral",
            "Elaboración de Formas de Diseño Floral"
        ]
    },
    ...
    soporteTecnico : {
        ...
        courses: [
            ...
            "Reparación de Tabletas",
            "Reparación de Monitores LCD/LED",
            "Mantenimiento de PC",
            "Mantenimiento de Laptop",
            "Instalación de Redes LAN",
            "Instalación y Configuración de Sistemas Operativos de Libre Distribución",
            "Instalación y Configuración de Sistemas de Seguridad IP",
            "Servicio a Redes para Sistemas Computacionales",
            "Aplicación de Funciones Básicas en inglés para Soporte Técnico a Equipos y Sistemas Computacionales",
            "Ensambla, Configura e Instala Hardware y Software en el Equipo de Cómputo",
            "Mantiene Hardware y Software en el Equipo de Cómputo",
            "Proporciona Soporte Técnico Presencial o a Distancia en Software de Aplicación y Hardware",
            "Diseña Redes de Computadoras",
            "Instala y Opera Redes de Computadoras",            
        ]
    },
    ...
    ingles : {
        ...
        courses: [
            ...
            "Senior 1",
            "Senior 2",
            "Traduce Textos Técnicos del Campo Industrial, utilizando Técnicas Directas e Indirectas",
    ...
    ofimatica : {
        ...
        courses : [
            ...
            "Desarrolla Aplicaciones utilizando Algoritmos y Programación Estructurada",
            "Desarrolla Software de Manejo de Datos",
            "Utiliza un Sistema Gestor de Bases de Datos para Recolección y Organización",
            "Analiza un Conjunto de Datos Masivos",
            "Aplica Proyectos de Uso de Datos Masivos"
        ]
    }
};
...
function createTitle(object){
    const countSpecialties = Object.keys(object).length;
    const title = document.createElement("h3");
    title.innerHTML=`
    Conoce nuestras ${countSpecialties} especialidades:
    `;
    return title;
}

function createLI (data, name, logo) {
    ...
    <div data-specialities="${data}">${name}</div>
    `;
...
function getSpecialities (object) {    
    ...
    for (const key in object) {        
        if (Object.hasOwnProperty.call(object, key)) {          
            ...
            //evaluar que tipo de propiedad es:
            const dataset = key;
            const li = createLI(dataset, name, logoRed)
...
function infoSpecialitie(specialitie){
    const date = BD_SPECIALITIES[specialitie];
    const container = document.createElement("div");
    container.innerHTML = `    
    <div class="result__container">
        <h5 class="result__container--title">Objetivo</h5>
        <p class="result__container__description">${date.objective}</p>
    </div>
    <div class="result__container">
        <h5 class="result__container--title">Campo Laboral</h5>
        <p class="result__container__description">${date.laborField}</p>
    </div>
    <div class="result__container" id="listOfCourses">
        <h5 class="result__container--title">Cursos de la especialidad de ${date.name}</h5>        
    </div>    
    `;
    const containerUL = addCourses(date.courses)
...
function addCourses(array){
    const containerUL = document.createElement("ul");
    containerUL.className = "result__container__description--UL";
    array.forEach( item => {
        const li = document.createElement("li");
        li.className= "section__specialities__UL--list result--li";
        li.innerText = item;
        containerUL.appendChild(li)
    })
    return containerUL
...
function createButtons(specialitie){
    const date = BD_SPECIALITIES[specialitie];    
    const container = document.createElement("div");
    container.className = "result__buttons"
    container.innerHTML= `
    <div class= "result__buttons__logo">
        <img src="${date.logoRed}">
    </div>
    `;
    const buttonBack =  buttonClosed();
...
const locate = function (e) {    
    ...
    if (!!specialitie) {
        ...
        const buttonsInit = createButtons(specialitie);
        const containerInfo = infoSpecialitie(specialitie);        
    
        window.scroll(0,0);
        nodeResult.append(buttonsInit, containerInfo);        
    }
}
...
//const URL = "https://backend-cursos-cecati13.uc.r.appspot.com";
